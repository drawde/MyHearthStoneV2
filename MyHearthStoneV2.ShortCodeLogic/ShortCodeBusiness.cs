...
namespace MyHearthStoneV2.ShortCodeLogic
{
    public class ShortCodeBusiness : BaseBLL<HS_ShortCode>
    {
        private IRepository<HS_ShortCode> _repository = new Repository<HS_ShortCode>();
        private ShortCodeBusiness()
        {
        }
        public static ShortCodeBusiness Instance = new ShortCodeBusiness();
