!(function(a, b) {
  ...
  var s = (function(a) {
    ...
    try {
      I.apply((F = J.call(v.childNodes)), v.childNodes), F[v.childNodes.length]
        .nodeType;
    } catch (a) {
      I = {
        apply: F.length
    ...
    (c = ea.support = {}), (f = ea.isXML = function(a) {
        ...
        ? (
            ...
            (c.getById = ha(function(a) {
              return (o.appendChild(
                a
              ).id = u), !e.getElementsByName || !e.getElementsByName(u).length;
            })),
            c.getById
              ? (
            ...
            (c.qsa = $.test(e.querySelectorAll)) &&
              (
                ha(function(a) {
                  (a.innerHTML =
                    "<select msallowclip=''><option selected=''></option></select>"), a.querySelectorAll("[msallowclip^='']").length && q.push("[*^$]=" + M + "*(?:''|\"\")"), a.querySelectorAll("[selected]").length || q.push("\\[" + M + "*(?:value|" + L + ")"), a.querySelectorAll(":checked").length || q.push(":checked");
                }),
                ha(function(a) {
                  ...
                  b.setAttribute(
                    "type",
                    "hidden"
                  ), a.appendChild(b).setAttribute("name", "D"), a.querySelectorAll("[name=d]").length && q.push("name" + M + "*[*^$|!~]?="), a.querySelectorAll(":enabled").length || q.push(":enabled", ":disabled"), a.querySelectorAll("*,:x"), q.push(",.*:");
                })
              ),
      ...
      preFilter: {
        ATTR: function(a) {
          return (a[1] = a[1].replace(ca, da)), (a[3] = (a[3] ||
            a[4] ||
            a[5] ||
            "")
            .replace(ca, da)), "~=" === a[2] &&
    ...
    function oa() {}
    (oa.prototype = d.filters =
      d.pseudos), (d.setFilters = new oa()), (g = ea.tokenize = function(a, b) {
      var c,
        e,
        f,
        g,
    ...
    function ua(a, b, c, d, e, f) {
      return d && !d[u] && (d = ua(d)), e &&
        !e[u] &&
        (e = ua(e, f)), ga(function(f, g, h, i) {
        var j,
          k,
          l,
          m = [],
    ...
    return (h = ea.compile = function(a, b) {
      ...
      if (((e = e || []), 1 === o.length)) {
        ...
        while (i--) {
          ...
          if (
            ...
            if ((j.splice(i, 1), (a = f.length && pa(j)), !a))
      ...
      return (n || h(a, o))(
        ...
        !p,
        e,
        (aa.test(a) && na(b.parentNode)) || b
      ), e;
    }), (c.sortStable =
      u.split("").sort(B).join("") ===
      u), (c.detectDuplicates = !!l), m(), (c.sortDetached = ha(function(a) {
  ...
  (m.filter = function(a, b, c) {
    ...
    find: function(a) {
      ...
      return (c = this.pushStack(e > 1 ? m.unique(c) : c)), (c.selector = this
        .selector
        ? this.selector + " " + a
        : a), c;
    },
  ...
  m.ready.promise = function(b) {
    if (!H)
      if (((H = m.Deferred()), "complete" === y.readyState))
        ...
        y.addEventListener("DOMContentLoaded", J, !1), a.addEventListener(
          "load",
          J,
          !1
        );
  ...
  function Q(a, b, d, e) {
    if (m.acceptData(a)) {
      ...
      if (
        ...
        return k || (k = i ? (a[h] = c.pop() || m.guid++) : h), j[k] ||
          (j[k] = i ? {} : { toJSON: m.noop }), ("object" == typeof b ||
          "function" == typeof b) &&
          (e
            ? (j[k] = m.extend(j[k], b))
            : (j[k].data = m.extend(j[k].data, b))), (g = j[k]), e ||
          (g.data || (g.data = {}), (g = g.data)), void 0 !== d &&
          (g[m.camelCase(b)] = d), "string" == typeof b
      ...
      if (g[h]) {
        if (b && (d = c ? g[h] : g[h].data)) {
          m.isArray(b)
            ...
            : b in d
              ? (b = [b])
              : ((b = m.camelCase(b)), (b = b in d ? [b] : b.split(" "))), (e =
            b.length);
  ...
  m.extend({
    ...
    hasData: function(a) {
      return (a = a.nodeType ? m.cache[a[m.expando]] : a[m.expando]), !!a &&
        !P(a);
    },
    data: function(a, b, c) {
      return Q(a, b, c);
  ...
  var S = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    ...
    U = function(a, b) {
      return (a = b || a), "none" === m.css(a, "display") ||
  ...
  (m.event = {
    ...
    add: function(a, b, c, d, e) {
      ...
      if (r) {
        c.handler && ((i = c), (c = i.handler), (e = i.selector)), c.guid ||
          (c.guid = m.guid++), (g = r.events) || (g = r.events = {}), (k =
          r.handle) ||
          (
            ...
            (k.elem = a)
          ), (b = (b || "").match(E) || [""]), (h = b.length);
        while (h--)
          (f = _.exec(b[h]) || []), (o = q = f[1]), (p = (f[2] || "")
            .split(".")
            .sort()), o &&
            (
              (j = m.event.special[o] || {}),
      ...
      if (r && (k = r.events)) {
        ...
        while (j--)
          if (
            ...
            (l = m.event.special[o] || {}), (o =
              (d ? l.delegateType : l.bindType) || o), (n = k[o] || []), (h =
              h[2] &&
              new RegExp(
                "(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"
              )), (i = f = n.length);
            while (f--)
              (g = n[f]), (!e && q !== g.origType) ||
                (c && c.guid !== g.guid) ||
    ...
    trigger: function(b, c, d, e) {
      ...
      if (
        ...
        while ((h = o[n++]) && !b.isPropagationStopped())
          (b.type = n > 1 ? i : k.bindType || p), (f =
            (m._data(h, "events") || {})[b.type] && m._data(h, "handle")), f &&
            f.apply(h, c), (f = g && h[g]), f &&
            f.apply &&
            m.acceptData(h) &&
          ...
          while ((e = f.handlers[g++]) && !a.isImmediatePropagationStopped())
            (!a.namespace_re || a.namespace_re.test(e.namespace)) &&
              (
                (a.handleObj = e),
                (a.data = e.data),
                (c = ((m.event.special[e.origType] || {}).handle || e.handler)
                  .apply(f.elem, i)),
                void 0 !== c &&
                  (a.result = c) === !1 &&
    ...
    fix: function(a) {
      ...
      return a.target || (a.target = f.srcElement || y), 3 ===
        a.target.nodeType &&
        (a.target = a.target.parentNode), (a.metaKey = !!a.metaKey), g.filter
        ? g.filter(a, f)
        : a;
    },
    ...
    simulate: function(a, b, c, d) {
      ...
      d
        ...
        : m.event.dispatch.call(b, e), e.isDefaultPrevented() &&
        c.preventDefault();
    }
    ...
    stopImmediatePropagation: function() {
      var a = this.originalEvent;
      (this.isImmediatePropagationStopped = aa), a &&
              ...
              ("checkbox" === this.type || "radio" === this.type) &&
                (
                  ...
                  m.event.add(this, "click._change", function(a) {
                    this._just_changed &&
                      !a.isTrigger &&
                      (this._just_changed = !1), m.event.simulate("change", this, a, !0);
                  })
                ),
              !1
            )
    ...
    off: function(a, b, c) {
      ...
      if (a && a.preventDefault && a.handleObj)
        return (d = a.handleObj), m(a.delegateTarget).off(
      ...
      return (b === !1 || "function" == typeof b) &&
        ((c = b), (b = void 0)), c === !1 && (c = ba), this.each(function() {
  ...
  (ra.optgroup =
    ra.option), (ra.tbody = ra.tfoot = ra.colgroup = ra.caption = ra.thead), (ra.th = ra.td);
  function ua(a, b) {
    var c,
      d,
      e = 0,
  ...
  m.extend({
    clone: function(a, b, c) {
      ...
      return (d = ua(f, "script")), d.length > 0 &&
        za(d, !i && ua(a, "script")), (d = h = e = null), f;
    },
    buildFragment: function(a, b, c, d) {
      for (
        ...
        if (((f = a[q]), f || 0 === f))
          if ("object" === m.type(f)) m.merge(p, f.nodeType ? [f] : f);
            ...
            (h = h || o.appendChild(b.createElement("div"))), (i = (ja.exec(
              f
            ) || ["", ""])[1]
              .toLowerCase()), (l = ra[i] || ra._default), (h.innerHTML =
              l[1] + f.replace(ia, "<$1></$2>") + l[2]), (e = l[0]);
      ...
      h && o.removeChild(h), k.appendChecked ||
        m.grep(ua(p, "input"), va), (q = 0);
      while ((f = p[q++]))
        if (
          (!d || -1 === m.inArray(f, d)) &&
          (
    ...
    remove: function(a, b) {
      for (
        ...
        b || 1 !== c.nodeType || m.cleanData(ua(c)), c.parentNode &&
          (
    ...
    replaceWith: function() {
      ...
      return this.domManip(arguments, function(b) {
        (a = this
          .parentNode), m.cleanData(ua(this)), a && a.replaceChild(b, this);
      ...
      if (
        ...
        if (f)
          for (
            ...
            (d = g[j]), oa.test(d.type || "") &&
              !m._data(d, "globalEval") &&
              m.contains(h, d) &&
              (d.src
                ? m._evalUrl && m._evalUrl(d.src)
                : m.globalEval(
                    (d.text || d.textContent || d.innerHTML || "")
                      .replace(qa, "")
                  ));
        i = c = null;
      }
    ...
    function(a, b) {
      m.fn[a] = function(a) {
        for (var c, d = 0, e = [], g = m(a), h = g.length - 1; h >= d; d++)
          (c = d === h ? this : this.clone(!0)), m(g[d])[b](c), f.apply(
            e,
            c.get()
          );
  ...
  function Fa(a) {
    ...
    return c ||
      (
        ...
        ("none" !== c && c) ||
          (
            (Ca = (Ca || m("<iframe frameborder='0' width='0' height='0'/>"))
  ...
  !(function() {
    ...
    if (
      ...
      (c.cssText = "float:left;opacity:.5"), (k.opacity =
        "0.5" ===
        c.opacity), (k.cssFloat = !!c.cssFloat), (b.style.backgroundClip =
        "content-box"), (b.cloneNode(!0).style.backgroundClip =
        ""), (k.clearCloneStyle =
        "content-box" === b.style.backgroundClip), (k.boxSizing =
        "" === c.boxSizing ||
        "" === c.MozBoxSizing ||
      ...
      function i() {
        var b, c, d, i;
        (c = y.getElementsByTagName("body")[0]), c &&
          c.style &&
          (
            (b = y.createElement("div")),
            (d = y.createElement("div")),
  ...
  function Xa(a, b, c, d, e) {
    for (
      ...
      "margin" === c && (g += m.css(a, c + T[f], !0, e)), d
        ? (
  ...
  m.extend({
    ...
    css: function(a, b, c, d) {
      var e,
        ...
        g,
        h = m.camelCase(b);
      return (b = m.cssProps[h] || (m.cssProps[h] = Ua(a.style, h))), (g =
        m.cssHooks[b] || m.cssHooks[h]), g &&
        "get" in g &&
        (f = g.get(a, !0, c)), void 0 === f && (f = Ja(a, b, d)), "normal" ===
        f &&
        b in Sa &&
        (f = Sa[b]), "" === c || c
  ...
  function ib(a, b, c) {
    ...
    if (m.isEmptyObject(o))
      ...
      r ? "hidden" in r && (q = r.hidden) : (r = m._data(a, "fxshow", {})), f &&
        (r.hidden = !q), q
        ? m(a).show()
        : n.done(function() {
            m(a).hide();
  ...
  function kb(a, b, c) {
    ...
    return m.map(
      ...
      hb,
      j
    ), m.isFunction(j.opts.start) && j.opts.start.call(a, j), m.fx.timer(m.extend(i, { elem: a, anim: j, queue: j.opts.queue })), j.progress(j.opts.progress).done(j.opts.done, j.opts.complete).fail(j.opts.fail).always(j.opts.always);
  }
  (m.Animation = m.extend(kb, {
    ...
    return (d.duration = m.fx.off
      ...
      m.isFunction(d.old) && d.old.call(this), d.queue &&
  ...
  }), (m.fx.speeds = { slow: 600, fast: 200, _default: 400 }), (m.fn.delay = function(
    a,
    b
  ) {
    return (a = m.fx ? m.fx.speeds[a] || a : a), (b =
    ...
    (b = y.createElement(
      "div"
    )), b.setAttribute("className", "t"), (b.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>"), (d = b.getElementsByTagName("a")[0]), (c = y.createElement("select")), (e = c.appendChild(y.createElement("option"))), (a = b.getElementsByTagName("input")[0]), (d.style.cssText = "top:1px"), (k.getSetAttribute = "t" !== b.className), (k.style = /top/.test(d.getAttribute("style"))), (k.hrefNormalized = "/a" === d.getAttribute("href")), (k.checkOn = !!a.value), (k.optSelected = e.selected), (k.enctype = !!y.createElement("form").enctype), (c.disabled = !0), (k.optDisabled = !e.disabled), (a = y.createElement("input")), a.setAttribute("value", ""), (k.input = "" === a.getAttribute("value")), (a.value = "t"), a.setAttribute("type", "radio"), (k.radioValue = "t" === a.value);
  })();
  var lb = /\r/g;
  m.fn.extend({
    val: function(a) {
        ...
        e = this[0];
      {
        ...
        if (e)
          return (b =
            m.valHooks[e.type] || m.valHooks[e.nodeName.toLowerCase()]), b &&
          "get" in b &&
    ...
    ob[b] =
      (rb && qb) || !pb.test(b)
        ...
        : function(a, b, c) {
            return c
              ? void 0
              : a[m.camelCase("default-" + b)] ? b.toLowerCase() : null;
          };
  }), (rb && qb) ||
    (m.attrHooks.value = {
      set: function(a, b, c) {
    ...
    propHooks: {
      tabIndex: {
        get: function(a) {
          ...
          return b
            ? parseInt(b, 10)
            : sb.test(a.nodeName) || (tb.test(a.nodeName) && a.href) ? 0 : -1;
        }
      }
    }
  }), k.hrefNormalized ||
  ...
  m.extend({
    ...
    ajax: function(a, b) {
      ...
      if ((i = Lb(Ib, k, b, v))) {
        (v.readyState = 1), h && n.trigger("ajaxSend", [v, k]), k.async &&
          k.timeout > 0 &&
  ...
  a.ActiveXObject &&
    ...
    }), (k.cors = !!Xb && "withCredentials" in Xb), (Xb = k.ajax = !!Xb), Xb &&
    ...
    return h || "jsonp" === b.dataTypes[0]
      ? (
          ...
          d.always(function() {
            (a[
              e
            ] = f), b[e] && ((b.jsonpCallback = c.jsonpCallback), $b.push(e)), g && m.isFunction(f) && f(g[0]), (g = f = void 0);
          }),
          "script"
        )
      : void 0;
  ...
  (m.fn.load = function(a, b, c) {
    ...
    var d,
      ...
      h = a.indexOf(" ");
    return h >= 0 &&
      ((d = m.trim(a.slice(h, a.length))), (a = a.slice(0, h))), m.isFunction(b)
      ? ((c = b), (b = void 0))
  ...
  (m.offset = {
    setOffset: function(a, b, c) {
      var d,
        ...
        n = {};
      "static" === k &&
        (a.style.position = "relative"), (h = l.offset()), (f = m.css(
        a,
        "top"
      )), (i = m.css(a, "left")), (j =
        ("absolute" === k || "fixed" === k) &&
        ...
        : ((g = parseFloat(f) || 0), (e = parseFloat(i) || 0)), m.isFunction(
        b
      ) && (b = b.call(a, c, h)), null != b.top &&
        (n.top = b.top - h.top + g), null != b.left &&
        (n.left = b.left - h.left + e), "using" in b
        ? b.using.call(a, n)
        : l.css(n);
    }
  }), m.fn.extend({
...
+(function(a) {
  ...
  (d.VERSION =
    "3.3.5"), (d.TRANSITION_DURATION = 150), (d.prototype.close = function(b) {
    function c() {
  ...
  (c.VERSION = "3.3.5"), (c.DEFAULTS = a.extend(
    ...
    a.find(".popover-title")[this.options.html ? "html" : "text"](b), a
      ...
      [this.options.html ? ("string" == typeof c ? "html" : "append") : "text"](
        c
      ), a.removeClass("fade top bottom left right in"), a
      .find(".popover-title")
...
!(function(a) {
  ...
  windowIsDefined &&
    !window.console &&
    (window.console = {}), windowIsDefined && !window.console.log && (window.console.log = function() {}), windowIsDefined && !window.console.warn && (window.console.warn = function() {});
  var d;
  return (function(a) {
    function b() {}
    function c(a) {
      ...
      function e(b, c) {
        a.fn[b] = function(e) {
          ...
          var m = this.map(function() {
            ...
            return d
              ? (d.option(e), d._init())
              : ((d = new c(this, e)), a.data(this, b, d)), a(this);
          });
    ...
    function e(b, c) {
      ...
      for (var e = Object.keys(this.defaultOptions), f = 0; f < e.length; f++) {
        var h = e[f],
          i = c[h];
        (i = "undefined" != typeof i ? i : d(this.element, h)), (i =
          null !== i ? i : this.defaultOptions[h]), this.options ||
          (this.options = {}), (this.options[h] = i);
      }
      ...
      if (this.sliderElem) p = !0;
        ...
        (this.sliderElem = document.createElement(
          "div"
        ...
        if (
          ...
          for (var s = 0; s < this.options.rangeHighlights.length; s++) {
            ...
            (t.className =
              "slider-rangeHighlight slider-selection"), this.rangeHighlightElements.push(
              t
            ), r.appendChild(t);
          }
        ...
        if (
          ...
          for (
            this.ticksContainer = document.createElement(
              "div"
            ), this.ticksContainer.className = "slider-tick-container", f = 0;
        ...
        if (
          ...
          for (
            this.tickLabelContainer = document.createElement(
              "div"
            ), this.tickLabelContainer.className =
              "slider-tick-label-container", f = 0;
            ...
            var z = document.createElement("div"),
              ...
              B =
                this.options.reversed && A
                  ...
                  : f;
            (z.className =
              "slider-tick-label"), (z.innerHTML = this.options.ticks_labels[
              B
            ]), this.tickLabels.push(z), this.tickLabelContainer.appendChild(z);
          }
        var C = function(a) {
        ...
        (D.className = "tooltip tooltip-main"), D.setAttribute(
          "role",
          "presentation"
        ), C(D);
        var E = document.createElement("div");
        (E.className = "tooltip tooltip-min"), E.setAttribute(
          "role",
          "presentation"
        ), C(E);
        var F = document.createElement("div");
        (F.className = "tooltip tooltip-max"), F.setAttribute(
          "role",
          "presentation"
        ), C(F), this.sliderElem.appendChild(r), this.sliderElem.appendChild(
          D
        ), this.sliderElem.appendChild(E), this.sliderElem.appendChild(F), this
          .tickLabelContainer &&
          this.sliderElem.appendChild(this.tickLabelContainer), this
          .ticksContainer &&
          this.sliderElem.appendChild(
            this.ticksContainer
          ), this.sliderElem.appendChild(m), this.sliderElem.appendChild(
          n
        ), q.insertBefore(
          this.sliderElem,
          this.element
      ...
      if (
            ...
            (
              ...
              ["left", "right", "top", "width", "height"].forEach(function(a) {
                this._removeProperty(
                  this.trackLow,
                  a
                ), this._removeProperty(this.trackSelection, a), this._removeProperty(this.trackHigh, a);
              }, this),
              [this.handle1, this.handle2].forEach(function(a) {
                this._removeProperty(
                  a,
                  "left"
                ), this._removeProperty(a, "right"), this._removeProperty(a, "top");
              }, this),
              [
                this.tooltip,
                this.tooltip_min,
                ...
                this._removeProperty(
                  a,
                  "left"
                ), this._removeProperty(a, "right"), this._removeProperty(a, "top"), this._removeProperty(a, "margin-left"), this._removeProperty(a, "margin-right"), this._removeProperty(a, "margin-top"), this._removeClass(a, "right"), this._removeClass(a, "left"), this._removeClass(a, "top");
              }, this)
            ),
        ...
        for (
          this._removeClass(this.handle1, "round triangle"), this._removeClass(
            this.handle2,
            "round triangle hide"
          ), f = 0;
          f < this.ticks.length;
      ...
      if (H)
        for (
          this._addClass(this.handle1, this.options.handle), this._addClass(
            this.handle2,
            this.options.handle
          ), f = 0;
          f < this.ticks.length;
      ...
      if (
        ...
        this.sliderElem.addEventListener(
          ...
          this.touchstart,
          K
        ), this.sliderElem.addEventListener("touchmove", this.touchmove, K);
      }
      if (
        (
        ...
        this._addClass(this.tooltip, "hide"), this._addClass(
          this.tooltip_min,
          "hide"
        ...
        if (
          ...
          var L = this._addTickListener(),
            M = L.addMouseEnter(this, this.handle1),
            N = L.addMouseLeave(this, this.handle1);
          (this.handleCallbackMap.handle1 = {
            mouseEnter: M,
            mouseLeave: N
          }), (M = L.addMouseEnter(this, this.handle2)), (N = L.addMouseLeave(
            this,
            this.handle2
        ...
        linear: {
          toValue: function(a) {
            ...
            if (this.options.ticks_positions.length > 0) {
              for (
                ...
                if (a <= this.options.ticks_positions[h]) {
                  (d = this.options.ticks[h - 1]), (f = this.options
                    .ticks_positions[h - 1]), (e = this.options.ticks[
                    h
            ...
            return k < this.options.min
              ? this.options.min
              : k > this.options.max ? this.options.max : k;
          },
            ...
            if (this.options.ticks_positions.length > 0) {
              for (
                ...
                if (a <= this.options.ticks[f]) {
                  (b = f > 0 ? this.options.ticks[f - 1] : 0), (d =
                    f > 0 ? this.options.ticks_positions[f - 1] : 0), (c = this
                    .options.ticks[f]), (e = this.options.ticks_positions[f]);
                  break;
                }
              if (f > 0) {
                var g = (a - b) / (c - b);
          ...
          toValue: function(a) {
            ...
            return (d =
              ...
              Math.round((d - this.options.min) / this.options.step) *
                this.options.step), d < this.options.min
              ? this.options.min
              : d > this.options.max ? this.options.max : d;
          },
          toPercentage: function(a) {
            if (this.options.max === this.options.min) return 0;
    ...
    (d = function(a, b) {
      ...
      setValue: function(a, b, c) {
        ...
        this.options.range
          ...
          : (this._state.percentage = [0, 0, 100]), this._layout();
        var f = this.options.range ? this._state.value : this._state.value[0];
        return this._setDataVal(f), b === !0 && this._trigger("slide", f), d !==
          f &&
          c === !0 &&
          this._trigger("change", { oldValue: d, newValue: f }), this;
      },
      destroy: function() {
        this._removeSliderEventHandlers(), this.sliderElem.parentNode.removeChild(
          this.sliderElem
        ), (this.element.style.display =
          ""), this._cleanUpEventCallbacksMap(), this.element.removeAttribute(
          "data"
        ), a &&
          (
      ...
      disable: function() {
        return (this._state.enabled = !1), this.handle1.removeAttribute(
          "tabindex"
        ), this.handle2.removeAttribute("tabindex"), this._addClass(
          this.sliderElem,
          "slider-disabled"
        ), this._trigger("slideDisabled"), this;
      },
      enable: function() {
        return (this._state.enabled = !0), this.handle1.setAttribute(
          "tabindex",
          0
        ), this.handle2.setAttribute("tabindex", 0), this._removeClass(
          this.sliderElem,
          "slider-disabled"
        ), this._trigger("slideEnabled"), this;
      },
      toggle: function() {
      ...
      refresh: function() {
        return this._removeSliderEventHandlers(), e.call(
          this,
          this.element,
          this.options
        ), a && a.data(this.element, "slider", this), this;
      },
      relayout: function() {
      ...
      _removeSliderEventHandlers: function() {
        if (
          ...
          for (
            var a = this.ticksContainer.getElementsByClassName("slider-tick"),
              b = 0;
            b < a.length;
            b++
          )
        ...
        (this.handleCallbackMap = null), (this.ticksCallbackMap = null), this
          .showTooltip &&
          (
      ...
      _bindNonQueryEventHandler: function(a, b) {
        void 0 === this.eventToCallbackMap[a] &&
          (this.eventToCallbackMap[a] = []), this.eventToCallbackMap[a].push(b);
      },
      ...
      _setToolTipOnMouseOver: function(a) {
        function b(a, b) {
          return b
            ? [
                100 - a.percentage[0],
                this.options.range ? 100 - a.percentage[1] : a.percentage[1]
              ]
        ...
        this._setText(this.tooltipInner, c), (this.tooltip.style[
          this.stylePos
        ] =
          d[0] + "%"), "vertical" === this.options.orientation
          ? this._css(
              this.tooltip,
          ...
          addMouseEnter: function(a, b, c) {
            var d = function() {
              var b = a._state,
                ...
                e = parseInt(d, 10);
              (b.value[0] = e), (b.percentage[0] =
                a.options.ticks_positions[e]), a._setToolTipOnMouseOver(
                b
              ), a._showTooltip();
            };
      ...
      _layout: function() {
        ...
        if (
          ...
          for (var b = 0; b < this.options.rangeHighlights.length; b++) {
            ...
            f
              ? "vertical" === this.options.orientation
                ? (
                    (this.rangeHighlightElements[b].style.top = f.start + "%"),
                    (this.rangeHighlightElements[b].style.height = f.size + "%")
                  )
                : (
                    this.options.rtl
                      ...
                      : (this.rangeHighlightElements[b].style.left =
                          f.start + "%"),
                    (this.rangeHighlightElements[b].style.width = f.size + "%")
                  )
        ...
        if (
          ...
          if (this.tickLabelContainer) {
            ...
            if (0 === this.options.ticks_positions.length)
              "vertical" !== this.options.orientation &&
                (this.tickLabelContainer.style[g] = -i / 2 + "px"), (j = this
                .tickLabelContainer.offsetHeight);
            else
          ...
          for (var k = 0; k < this.options.ticks.length; k++) {
            ...
            this.options.reversed && (l = 100 - l), (this.ticks[k].style[
              this.stylePos
            ] =
              l + "%"), this._removeClass(this.ticks[k], "in-selection"), this
              .options.range
              ? l >= a[0] &&
                l <= a[1] &&
              ...
              : "after" === this.options.selection && l >= a[0]
                ...
                : "before" === this.options.selection &&
                  l <= a[0] &&
                  this._addClass(this.ticks[k], "in-selection"), this
              .tickLabels[k] &&
              (
        ...
        if (this.options.range) {
          (m = this.options.formatter(this._state.value)), this._setText(
            this.tooltipInner,
            m
          ), (this.tooltip.style[this.stylePos] =
            (a[1] + a[0]) / 2 + "%"), "vertical" === this.options.orientation
            ? this._css(
                this.tooltip,
                "margin-" + this.stylePos,
                -this.tooltip.offsetHeight / 2 + "px"
          ...
          this._setText(this.tooltipInner_max, o), (this.tooltip_min.style[
            this.stylePos
          ] =
            a[0] + "%"), "vertical" === this.options.orientation
            ? this._css(
                this.tooltip_min,
                "margin-" + this.stylePos,
            ...
            a[1] + "%"), "vertical" === this.options.orientation
            ? this._css(
                this.tooltip_max,
                "margin-" + this.stylePos,
          ...
          (m = this.options.formatter(this._state.value[0])), this._setText(
            this.tooltipInner,
            m
          ), (this.tooltip.style[this.stylePos] = a[0] + "%"), "vertical" ===
        ...
        if ("vertical" === this.options.orientation)
          (this.trackLow.style.top = "0"), (this.trackLow.style.height =
            Math.min(a[0], a[1]) + "%"), (this.trackSelection.style.top =
            Math.min(a[0], a[1]) + "%"), (this.trackSelection.style.height =
            Math.abs(a[0] - a[1]) + "%"), (this.trackHigh.style.bottom =
            "0"), (this.trackHigh.style.height =
            100 - Math.min(a[0], a[1]) - Math.abs(a[0] - a[1]) + "%");
        else {
          "right" === this.stylePos
            ? (this.trackLow.style.right = "0")
            : (this.trackLow.style.left = "0"), (this.trackLow.style.width =
            Math.min(a[0], a[1]) + "%"), "right" === this.stylePos
            ? (this.trackSelection.style.right = Math.min(a[0], a[1]) + "%")
            : (this.trackSelection.style.left =
                Math.min(a[0], a[1]) + "%"), (this.trackSelection.style.width =
            Math.abs(a[0] - a[1]) + "%"), "right" === this.stylePos
            ? (this.trackHigh.style.left = "0")
            : (this.trackHigh.style.right = "0"), (this.trackHigh.style.width =
            100 - Math.min(a[0], a[1]) - Math.abs(a[0] - a[1]) + "%");
      ...
      _createHighlightRange: function(a, b) {
        return this._isHighlightRange(a, b)
          ? a > b ? { start: b, size: a - b } : { start: a, size: b - a }
          : null;
      },
      ...
      _resize: function(a) {
        (this._state.offset = this._offset(
          this.sliderElem
        )), (this._state.size = this.sliderElem[this.sizePos]), this._layout();
      },
      ...
      _mousedown: function(a) {
        ...
        if (this.options.range) {
          ...
          (this._state.dragged =
            d > c ? 0 : 1), this._adjustPercentageForRangeSliders(b);
        } else this._state.dragged = 0;
        (this._state.percentage[this._state.dragged] = b), this._layout(), this
          .touchCapable &&
          (
            document.removeEventListener("touchmove", this.mousemove, !1),
            document.removeEventListener("touchend", this.mouseup, !1)
          ), this.mousemove &&
          document.removeEventListener("mousemove", this.mousemove, !1), this
          .mouseup &&
          document.removeEventListener(
            "mouseup",
            this.mouseup,
            !1
          ), (this.mousemove = this._mousemove.bind(
          this
        )), (this.mouseup = this._mouseup.bind(this)), this.touchCapable &&
          (
        ...
        return this._trigger("slideStart", e), this._setDataVal(
          e
        ), this.setValue(e, !1, !0), (a.returnValue = !1), this.options.focus &&
          this._triggerFocusOnHandle(this._state.dragged), !0;
      },
      ...
      _keydown: function(a, b) {
        ...
        if (c) {
          ...
          return this._trigger("slideStart", f), this._setDataVal(
            f
          ), this.setValue(f, !0, !0), this._setDataVal(f), this._trigger(
            "slideStop",
            f
          ), this._layout(), this._pauseEvent(b), delete this._state
            .keyCtrl, !1;
        }
      },
      _pauseEvent: function(a) {
        a.stopPropagation && a.stopPropagation(), a.preventDefault &&
          a.preventDefault(), (a.cancelBubble = !0), (a.returnValue = !1);
      },
      _mousemove: function(a) {
        if (!this._state.enabled) return !1;
        var b = this._getPercentage(a);
        this._adjustPercentageForRangeSliders(b), (this._state.percentage[
          this._state.dragged
        ] = b), this._layout();
          ...
          this._applyToFixedAndParseFloat(this._state.percentage[1], b) < c
            ...
            : 1 === this._state.dragged &&
              ...
              : 0 === this._state.keyCtrl &&
                this._state.value[1] / this.options.max * 100 < a
                ? (
                    (this._state.percentage[0] = this._state.percentage[1]),
                ...
                : 1 === this._state.keyCtrl &&
                  this._state.value[0] / this.options.max * 100 > a &&
                  (
                    (this._state.percentage[1] = this._state.percentage[0]),
      ...
      _mouseup: function() {
        ...
        this.touchCapable &&
          ...
          this.mouseup,
          !1
        ), (this._state.inDrag = !1), this._state.over === !1 &&
          this._hideTooltip();
        var a = this._calculateValue(!0);
        return this._layout(), this._setDataVal(a), this._trigger(
          "slideStop",
          a
        ), !1;
      },
      ...
      _getPercentage: function(a) {
        ...
        return (e =
          ...
          this._state.percentage[2]), this.options.reversed &&
          (e = 100 - e), Math.max(0, Math.min(100, e));
      },
      ...
      _setDataVal: function(a) {
        this.element.setAttribute("data-value", a), this.element.setAttribute(
          "value",
          a
      ...
      _setTooltipPosition: function() {
        ...
        if ("vertical" === this.options.orientation) {
          ...
          "bottom" === this.options.tooltip_position
            ...
            : a.forEach(
                function(a) {
                  this._addClass(a, "top"), (a.style.top =
      ...
      !(function() {
        ...
        a.fn.slider
          ...
          : (a.bridget(b, d), (e = b)), a.bridget(c, d), a(function() {
...
(function(a, b, c) {
  ...
  function d(c) {
    ...
    Na = c.edgeStrategy || "set";
    va = { beforerender: c.beforerender, render: c.render };
    wa = c.forceHeight !== false;
    if (wa) {
      ya = c.scale || 1;
    }
    Aa = c.mobileDeceleration || y;
    Ia = c.smoothScrolling !== false;
    Ja = c.smoothScrollingDuration || z;
    Ka = { targetTop: sa.getScrollTop() };
    Oa = (c.mobileCheck ||
      function() {
    ...
    if (Oa) {
      ua = b.getElementById("skrollr-body");
      if (ua) {
        fa();
      }
      W();
    ...
    sa.refresh();
    ga(a, "resize orientationchange", function() {
      var a = i.clientWidth;
  ...
  var C = "center";
  var D = "bottom";
  var E = "___skrollable_id";
  var F = /^(?:input|textarea|button|select)$/i;
  var G = /^\s+|\s+$/g;
  ...
  var S = function() {
    ...
    if (Q.slice(0, 1) === "-") {
      R = Q;
      Q = { "-webkit-": "webkit", "-moz-": "Moz", "-ms-": "ms", "-o-": "O" }[Q];
    } else {
      R = "-" + Q.toLowerCase() + "-";
    }
  };
  var T = function() {
    var b =
      a.requestAnimationFrame || a[Q.toLowerCase() + "RequestAnimationFrame"];
    var c = qa();
    if (Oa || !b) {
      b = function(b) {
        var d = qa() - c;
        var e = g.max(0, 1e3 / 60 - d);
  ...
  var U = function() {
    var b =
      a.cancelAnimationFrame || a[Q.toLowerCase() + "CancelAnimationFrame"];
    if (Oa || !b) {
      b = function(b) {
  ...
  var V = {
    ...
    swing: function(a) {
      return -g.cos(a * g.PI) / 2 + 0.5;
    },
    sqrt: function(a) {
      return g.sqrt(a);
    },
    outCubic: function(a) {
      return g.pow(a - 1, 3) + 1;
    },
    bounce: function(a) {
      var b;
      if (a <= 0.5083) {
      ...
      return 1 - g.abs(3 * g.cos(a * b * 1.028) / b);
    }
  };
  d.prototype.refresh = function(a) {
    ...
    for (; d < e; d++) {
      ...
      var l = 0;
      var m = g.attributes.length;
      for (; l < m; l++) {
        var n = g.attributes[l];
        if (n.name === "data-anchor-target") {
          h = b.querySelector(n.value);
          if (h === null) {
            throw 'Unable to find anchor target "' + n.value + '"';
          }
          continue;
        }
        if (n.name === "data-smooth-scrolling") {
          j = n.value !== "off";
          continue;
        }
        if (n.name === "data-edge-strategy") {
          k = n.value;
          continue;
        }
        ...
        var q = { props: n.value, element: g };
        i.push(q);
        var r = p[1];
        if (r) {
          q.constant = r.substr(1);
        }
        var s = p[2];
        if (/p$/.test(s)) {
          q.isPercentage = true;
          q.offset = (s.slice(0, -1) | 0) / 100;
        } else {
          q.offset = s | 0;
        }
        var t = p[3];
        ...
        if (!t || t === A || t === B) {
          ...
          if (t === B) {
            q.isEnd = true;
          } else if (!q.isPercentage) {
            q.offset = q.offset * ya;
          }
        } else {
          q.mode = "relative";
          q.anchors = [t, u];
  ...
  d.prototype.relativeToAbsolute = function(a, b, c) {
    var d = i.clientHeight;
    var e = a.getBoundingClientRect();
    var f = e.top;
    var g = e.bottom - e.top;
    if (b === D) {
      f -= d;
    } else if (b === C) {
      f -= d / 2;
  ...
  d.prototype.getScrollTop = function() {
    if (Oa) {
      ...
      return a.pageYOffset || i.scrollTop || j.scrollTop || 0;
    }
  };
  ...
  d.prototype.destroy = function() {
    ...
    i.style.overflow = j.style.overflow = "auto";
    i.style.height = j.style.height = "auto";
    if (ua) {
      e.setStyle(ua, "transform", "none");
    }
    sa = c;
    ua = c;
    va = c;
    ...
    ga(i, [k, l, m, n].join(" "), function(a) {
      ...
      switch (a.type) {
        case k:
          ...
          break;
        case l:
          if (F.test(h.tagName) && b.activeElement !== h) {
            a.preventDefault();
          }
          r = o - q;
          v = t - u;
          sa.setScrollTop(Pa - r, true);
          q = o;
          u = t;
          break;
        default:
        ...
        case n:
          ...
          z = g.max(g.min(z, 3), -3);
          var A = g.abs(z / Aa);
          var B = z * A + 0.5 * Aa * A * A;
          var C = sa.getScrollTop() - B;
          var D = 0;
          if (C > xa) {
            D = (xa - C) / B;
            C = xa;
          ...
          A = A * (1 - D);
          sa.animateTo((C + 0.5) | 0, { easing: "outCubic", duration: A });
          break;
      }
    });
    a.scrollTo(0, 0);
    i.style.overflow = j.style.overflow = "hidden";
  };
  var X = function() {
    ...
    for (; l < m; l++) {
      ...
      for (; h < j; h++) {
        ...
        if (k.mode === "relative") {
          ea(d);
          k.frame = sa.relativeToAbsolute(e, k.anchors[0], k.anchors[1]) - n;
          ea(d, true);
        }
        k.frame += o;
        if (wa) {
          if (!k.isEnd && k.frame > xa) {
            xa = k.frame;
          }
        }
      }
  ...
  var Y = function(a, b) {
    ...
    for (; c < d; c++) {
      var g = ta[c];
      var h = g.element;
      var i = g.smoothScrolling ? a : b;
      var j = g.keyFrames;
      var k = j[0].frame;
      var l = j[j.length - 1].frame;
      var m = i < k;
      var n = i > l;
      var s = j[m ? 0 : j.length - 1];
      var t;
      var u;
      if (m || n) {
        if ((m && g.edge === -1) || (n && g.edge === 1)) {
          continue;
        }
        na(h, [m ? p : r], [p, q, r]);
        g.edge = m ? -1 : 1;
        switch (g.edgeStrategy) {
          case "reset":
            ea(h);
            continue;
          case "ease":
      ...
      var x = j.length - 1;
      for (; w < x; w++) {
        if (i >= j[w].frame && i <= j[w + 1].frame) {
          var y = j[w];
          var z = j[w + 1];
          for (t in y.props) {
            if (f.call(y.props, t)) {
              var A = (i - y.frame) / (z.frame - y.frame);
              A = y.props[t].easing(A);
              u = ca(y.props[t].value, z.props[t].value, A);
              u = da(u);
              e.setStyle(h, t, u);
            }
          }
  ...
  var Z = function() {
    ...
    if (Ha) {
      if (d >= Ha.endTime) {
        ...
        f = Ha.easing((d - Ha.startTime) / Ha.duration);
        a = (Ha.startTop + f * Ha.topDiff) | 0;
      }
      sa.setScrollTop(a, true);
    } else if (!La) {
      ...
      if (d <= Ka.endTime) {
        f = V.sqrt((d - Ka.startTime) / Ja);
        a = (Ka.startTop + f * Ka.topDiff) | 0;
      }
    }
    if (Oa && ua) {
      e.setStyle(ua, "transform", "translate(0, " + -Pa + "px) " + Qa);
    }
    if (La || Ca !== a) {
      Ba = a > Ca ? "down" : a < Ca ? "up" : Ba;
      La = false;
      var h = { curTop: a, lastTop: Ca, maxTop: xa, direction: Ba };
      var i = va.beforerender && va.beforerender.call(sa, h);
      if (i !== false) {
        Y(a, sa.getScrollTop());
        Ca = a;
        if (va.render) {
  ...
  var $ = function(a) {
    ...
    for (; b < c; b++) {
      ...
      while ((i = I.exec(d.props)) !== null) {
        ...
        f = f.indexOf("!") ? _(f) : [f.slice(1)];
        h[g] = { value: f, easing: V[e] };
      }
      d.props = h;
    }
  };
  ...
  var ea = function(a, b) {
    ...
    for (; e < f; e++) {
      ...
      if (b) {
        ...
        na(d, c.dirtyClassAttr);
      } else {
        c.dirtyStyleAttr = d.style.cssText;
        c.dirtyClassAttr = ma(d);
  ...
  var fa = function() {
    Qa = "translateZ(0)";
    e.setStyle(ua, "transform", Qa);
    var a = h(ua);
    var b = a.getPropertyValue("transform");
    var c = a.getPropertyValue(R + "transform");
    var d = (b && b !== "none") || (c && c !== "none");
    if (!d) {
      Qa = "";
    }
  };
  e.setStyle = function(a, b, c) {
    ...
    if (b === "zIndex") {
      ...
      try {
        if (Q) {
          d[Q + b.slice(0, 1).toUpperCase() + b.slice(1)] = c;
        }
        d[b] = c;
      } catch (a) {}
    }
  };
  var ga = (e.addEvent = function(b, c, d) {
    var e = function(b) {
      b = b || a.event;
      if (!b.target) {
    ...
    for (; g < h; g++) {
      ...
      if (b.addEventListener) {
        b.addEventListener(f, d, false);
      } else {
        b.attachEvent("on" + f, e);
      }
      Ra.push({ element: b, name: f, listener: d });
    }
  });
  var ha = (e.removeEvent = function(a, b, c) {
    b = b.split(" ");
    var d = 0;
    var e = b.length;
    for (; d < e; d++) {
      if (a.removeEventListener) {
        a.removeEventListener(b[d], c, false);
      } else {
  ...
  var ia = function() {
    ...
    for (; b < c; b++) {
      a = Ra[b];
      ha(a.element, a.name, a.listener);
    }
    Ra = [];
  };
  var ja = function() {
    ...
    X();
    if (wa && !Oa) {
      j.style.height = xa + i.clientHeight + "px";
    }
    if (Oa) {
      sa.setScrollTop(g.min(sa.getScrollTop(), xa));
    } else {
      sa.setScrollTop(a, true);
    }
    La = true;
  ...
  var la = function() {
    ...
    return b - i.clientHeight;
  };
  var ma = function(b) {
    var c = "className";
    if (a.SVGElement && b instanceof a.SVGElement) {
      b = b[c];
      c = "baseVal";
    }
    return b[c];
  };
  var na = function(b, d, e) {
    var f = "className";
    if (a.SVGElement && b instanceof a.SVGElement) {
      b = b[f];
      f = "baseVal";
    ...
    var i = e.length;
    for (; h < i; h++) {
      g = pa(g).replace(pa(e[h]), " ");
    }
    g = oa(g);
    var j = 0;
    var k = d.length;
    for (; j < k; j++) {
      if (pa(g).indexOf(pa(d[j])) === -1) {
        g += " " + d[j];
      }
    }
    b[f] = oa(g);
...
(function(a) {
  a.flexslider = function(b, c) {
    ...
    var e = d.vars.namespace,
      ...
      i = "",
      j,
      k = d.vars.direction === "vertical",
      l = d.vars.reverse,
      m = d.vars.itemWidth > 0,
      n = d.vars.animation === "fade",
      o = d.vars.asNavFor !== "",
      p = {},
      q = true;
    ...
    p = {
      init: function() {
        ...
        if (d.vars.manualControls !== "")
          d.manualControls =
            a(d.vars.manualControls).length > 0 && a(d.vars.manualControls);
        if (d.vars.randomize) {
        ...
        if (
          d.vars.keyboard &&
          (a(d.containerSelector).length === 1 || d.vars.multipleKeyboard)
        ) {
      ...
      touch: function() {
        ...
        if (!f) {
          o = function(b) {
            ...
            h = k ? a - s : a - r;
            q = k
              ? Math.abs(h) < Math.abs(r - c)
              : Math.abs(h) < Math.abs(s - c);
            var f = 500;
            if (!q || Number(new Date()) - i > f) {
              b.preventDefault();
              if (!n && d.transitions) {
                if (!d.vars.animationLoop) {
                  h =
                    h /
                    ((d.currentSlide === 0 && h < 0) ||
          ...
          p = function(f) {
            b.removeEventListener("touchmove", o, false);
            if (d.animatingTo === d.currentSlide && !q && !(h === null)) {
              var j = l ? -h : h,
                k = j > 0 ? d.getTarget("next") : d.getTarget("prev");
              if (
                d.canAdvance(k) &&
                ((Number(new Date()) - i < 550 && Math.abs(j) > 50) ||
                  Math.abs(j) > g / 2)
              ) {
                d.flexAnimate(k, d.vars.pauseOnAction);
              } else {
                if (!n)
                  d.flexAnimate(d.currentSlide, d.vars.pauseOnAction, true);
              }
            }
            b.removeEventListener("touchend", p, false);
            a = null;
            c = null;
            h = null;
            e = null;
          ...
          j = function(f) {
            if (d.animating) {
              ...
              a = k ? s : r;
              c = k ? r : s;
              b.addEventListener("touchmove", o, false);
              b.addEventListener("touchend", p, false);
            }
          };
          b.addEventListener("touchstart", j, false);
        } else {
          ...
          function v(a) {
            ...
            t = t + (k ? f : d);
            h = t;
            q = k ? Math.abs(t) < Math.abs(-d) : Math.abs(t) < Math.abs(-f);
            ...
            if (!q || Number(new Date()) - i > 500) {
              a.preventDefault();
              if (!n && c.transitions) {
                if (!c.vars.animationLoop) {
                  h =
                    t /
                    ((c.currentSlide === 0 && t < 0) ||
          ...
          function w(b) {
            ...
            if (d.animatingTo === d.currentSlide && !q && !(h === null)) {
              var f = l ? -h : h,
                j = f > 0 ? d.getTarget("next") : d.getTarget("prev");
              if (
                d.canAdvance(j) &&
          ...
          if (p.pauseInvisible.visProp) {
            ...
            document.addEventListener(c, function() {
              if (p.pauseInvisible.isHidden()) {
                if (d.startTimeout) clearTimeout(d.startTimeout);
                else d.pause();
              } else {
                if (d.started) d.play();
                else
    ...
    d.flexAnimate = function(b, c, f, h, i) {
      ...
      if (!d.animating && (d.canAdvance(b, i) || f) && d.is(":visible")) {
        if (o && h) {
          ...
          if (
            Math.ceil((b + 1) / d.visible) - 1 !== d.currentSlide &&
            b !== 0
          ) {
            d.currentItem = b;
            d.slides
              ...
              return b === "setTouch"
                ...
                : l && d.animatingTo === d.last
                  ...
                  : l
                    ? d.limit -
                      (d.itemW + d.vars.itemMargin) * d.move * d.animatingTo
                    : d.animatingTo === d.last ? d.limit : c;
            } else {
              switch (b) {
                case "setTotal":
                  return l
    ...
    d.setup = function(b) {
      if (!n) {
        ...
        if (k && !m) {
          d.container
            .height((d.count + d.cloneCount) * 200 + "%")
      ...
      if (m) {
        ...
        d.itemW =
          d.minW > d.w
            ...
            : d.maxW < d.w
              ? (d.w - b * (e - 1)) / e
              : d.vars.itemWidth > d.w ? d.w : d.vars.itemWidth;
        d.visible = Math.floor(d.w / d.itemW);
        d.move =
          d.vars.move > 0 && d.vars.move < d.visible ? d.vars.move : d.visible;
  ...
  var a = jQuery,
    ...
    c = (function() {
      ...
      return (b.prototype.init = function() {
        ...
        ).appendTo(a("body")), (this.$lightbox = a(
          "#lightbox"
        )), (this.$overlay = a(
          "#lightboxOverlay"
        ...
        var d = this,
          e = a(window);
        e.on("resize", a.proxy(this.sizeOverlay, this)), a(
          "select, object, embed"
        ).css({ visibility: "hidden" }), this.sizeOverlay(), (this.album = []);
        var f,
          g = 0,
        ...
        this.$overlay.fadeIn(this.options.fadeDuration), a(".lb-loader").fadeIn(
          "slow"
        ), this.$lightbox
          .find(
        ...
        (e.onload = function() {
          var f, g, h, i, j, k, l;
          d.attr("src", c.album[b].link), (f = a(e)), d.width(
            e.width
          ), d.height(e.height), c.options.fitImagesInViewport &&
            (
              (l = a(window).width()),
              (k = a(window).height()),
        ...
        function c() {
          d.$lightbox.find(".lb-dataContainer").width(g), d.$lightbox
            .find(".lb-prevLink")
            .height(h), d.$lightbox
            .find(".lb-nextLink")
            .height(h), d.showImage();
        }
        var d = this,
        ...
        var a = !1;
        try {
          document.createEvent("TouchEvent"), (a = this.options
            .alwaysShowNavOnTouchDevices
            ? !0
            : !1);
        } catch (a) {}
        this.$lightbox.find(".lb-nav").show(), this.album.length > 1 &&
        ...
        this.disableKeyboardNav(), a(window).off(
          "resize",
          this.sizeOverlay
        ), this.$lightbox.fadeOut(
          this.options.fadeDuration
        ), this.$overlay.fadeOut(this.options.fadeDuration), a(
          "select, object, embed"
...
!(function(a) {
  ...
  a.fn.extend({
    ...
    smoothScroll: function(c) {
      ...
      return this.unbind(
        "click.smoothscroll"
      ).bind("click.smoothscroll", function(c) {
        var f = this,
          g = a(this),
          h = d.exclude,
          i = d.excludeWithin,
          ...
          o =
            d.scrollTarget ||
            (a.smoothScroll.filterPath(f.pathname) || e) === e,
          p = b(f.hash);
        if (d.scrollTarget || (n && o && p)) {
          for (; l && h.length > j; ) g.is(b(h[j++])) && (l = !1);
          for (; l && i.length > k; ) g.closest(i[k++]).length && (l = !1);
        } else l = !1;
        l &&
          (
            c.preventDefault(),
            a.extend(m, d, { scrollTarget: d.scrollTarget || p, link: f }),
            a.smoothScroll(m)
          );
      }), this;
    }
    ...
    "number" == typeof b
      ...
      : (
          (d = a.extend({}, a.fn.smoothScroll.defaults, b || {})),
          d.scrollElement &&
            (
              (i = "position"),
        ...
        ), (d = a.extend({ link: null }, d)), (j =
      "left" == d.direction ? "scrollLeft" : j), d.scrollElement
      ? ((e = d.scrollElement), (h = e[j]()))
      : (e = a("html, body").firstScrollable()), d.beforeScroll.call(e, d), (f =
      "number" == typeof b
        ? b
        : c ||
          (a(d.scrollTarget)[i]() && a(d.scrollTarget)[i]()[d.direction]) ||
          0), (k[j] = f + h + d.offset), (g = d.speed), "auto" === g &&
      ((g = k[j] || e.scrollTop()), (g /= d.autoCoefficent)), (l = {
      duration: g,
      easing: d.easing,
      complete: function() {
        d.afterScroll.call(d.link, d);
      }
    }), d.step && (l.step = d.step), e.length
      ? e.stop().animate(k, l)
      : d.afterScroll.call(d.link, d);
...
(function() {
  ...
  JQClass.extend = function b(c) {
    ...
    for (var f in c) {
      e[f] =
        typeof c[f] == "function" && typeof d[f] == "function"
          ? (function(a, b) {
              return function() {
                var c = this._super;
  ...
  JQClass.classes.JQPlugin = JQClass.extend({
    ...
    _init: function() {
      ...
      $.fn[a] = function(b) {
        ...
        if ($[a]._isNotChained(b, c)) {
          return $[a][b].apply($[a], [this[0]].concat(c));
        }
        return this.each(function() {
          if (typeof b === "string") {
            if (b[0] === "_" || !$[a][b]) {
...
(function(a) {
  ...
  function b(a, b, c) {
    return a.addEventListener
      ...
      : a.attachEvent ? a.attachEvent("on" + b, c) : void 0;
  }
  function c(a, b) {
    var c, d;
  ...
  a.Placeholders = {
    Utils: { addEventListener: b, inArray: c, moveCaret: d, changeType: e }
  };
})(this), (function(a) {
  "use strict";
  function b() {}
  ...
  function d(a, b) {
    ...
    return (e || f) && "true" === a.getAttribute(I)
      ? (
          a.removeAttribute(I),
          ...
          (d = a.getAttribute(O)),
          parseInt(d, 10) >= 0 &&
            (a.setAttribute("maxLength", d), a.removeAttribute(O)),
          (c = a.getAttribute(J)),
          c && (a.type = c),
          !0
        )
  ...
  function e(a) {
    ...
    return "" === a.value && d
      ? (
          ...
          (a.className += " " + F),
          (c = a.getAttribute(O)),
          c || (a.setAttribute(O, a.maxLength), a.removeAttribute("maxLength")),
          (b = a.getAttribute(J)),
          b
            ? (a.type = "text")
            : "password" === a.type &&
              T.changeType(a, "text") &&
              a.setAttribute(J, "password"),
          !0
        )
      : !1;
  }
  function f(a, b) {
    ...
    if (a && a.getAttribute(H)) b(a);
      ...
      for (
        e = a ? a.getElementsByTagName("input") : p, f = a
          ? a.getElementsByTagName("textarea")
          : q, c = e ? e.length : 0, d = f ? f.length : 0, i = 0, h = c + d;
        h > i;
        i++
      )
        (g = c > i ? e[i] : f[i - c]), b(g);
  ...
  function i(a) {
    return function() {
      r && a.value === a.getAttribute(H) && "true" === a.getAttribute(I)
        ? T.moveCaret(a, 0)
        : d(a);
    };
  }
  ...
  function k(a) {
    return function(b) {
      return (t = a.value), "true" === a.getAttribute(I) &&
      t === a.getAttribute(H) &&
      T.inArray(D, b.keyCode)
  ...
  function m(a) {
    return function() {
      a === c() &&
        a.value === a.getAttribute(H) &&
        "true" === a.getAttribute(I) &&
        T.moveCaret(a, 0);
    };
  }
  function n(a) {
  ...
  function o(a) {
    a.form &&
      (
        ...
        y.getAttribute(K) ||
          (T.addEventListener(y, "submit", n(y)), y.setAttribute(K, "true"))
      ), T.addEventListener(a, "focus", i(a)), T.addEventListener(
      a,
      "blur",
      j(a)
    ), r &&
      (
        T.addEventListener(a, "keydown", k(a)),
        T.addEventListener(a, "keyup", l(a)),
        T.addEventListener(a, "click", m(a))
      ), a.setAttribute(L, "true"), a.setAttribute(H, w), (r || a !== c()) &&
      e(a);
  }
  var p,
    q,
  ...
  if (((S.nativeSupport = void 0 !== P.placeholder), !S.nativeSupport)) {
    for (
      p = document.getElementsByTagName(
        "input"
      ), q = document.getElementsByTagName("textarea"), r =
        "false" === R.getAttribute(M), s =
        "false" !== R.getAttribute(N), u = document.createElement(
        "style"
      ), u.type = "text/css", v = document.createTextNode(
        "." + F + " { color:" + E + "; }"
      ), u.styleSheet
        ? (u.styleSheet.cssText = v.nodeValue)
        : u.appendChild(v), Q.insertBefore(u, Q.firstChild), B = 0, A =
        p.length + q.length;
      A > B;
      B++
    )
      (z = p.length > B ? p[B] : q[B - p.length]), (w =
        z.attributes.placeholder), w &&
        ((w = w.nodeValue), w && T.inArray(C, z.type) && o(z));
        ...
        (z = p.length > B ? p[B] : q[B - p.length]), (w =
          ...
          ? (
              ...
              w &&
                T.inArray(C, z.type) &&
                (
                  z.getAttribute(L) || o(z),
                  (w !== z.getAttribute(H) ||
                    ("password" === z.type && !z.getAttribute(J))) &&
                    (
                      "password" === z.type &&
                        !z.getAttribute(J) &&
                        T.changeType(z, "text") &&
                        z.setAttribute(J, "password"),
                      z.value === z.getAttribute(H) && (z.value = w),
                      z.setAttribute(H, w)
                    )
                )
            )
          : z.getAttribute(I) && (d(z), z.removeAttribute(H));
      s || clearInterval(x);
    }, 100);
  }
  T.addEventListener(a, "beforeunload", function() {
    S.disable();
  }), (S.disable = S.nativeSupport ? b : g), (S.enable = S.nativeSupport
    ? b
    : h);
})(this);
!(function() {
  ...
  (function() {
    function a(a) {
      ...
      function d(a) {
          ...
          if (/\\[bdsw]/i.test(h)) f.push(h);
            ...
            65 > i ||
              ...
              (
                65 > i ||
                  90 < h ||
                  a.push([Math.max(65, h) | 32, Math.min(i, 90) | 32]),
                97 > i ||
                  122 < h ||
                  a.push([Math.max(97, h) & -33, Math.min(i, 122) & -33])
              );
          }
        }
        a.sort(function(a, b) {
        ...
        for (e = 0; e < d.length; ++e)
          (h = d[e]), f.push(c(h[0])), h[1] > h[0] &&
            (h[1] + 1 > h[0] && f.push("-"), f.push(c(h[1])));
        f.push("]");
        return f.join("");
      }
      function e(a) {
        for (
          var b = a.source.match(
        ...
        for (j = i = 0; i < e; ++i)
          (k = b[i]), "(" === k
            ...
            : "\\" === k.charAt(0) &&
              ...
              k <= j &&
              (b[i] = "\\" + h[k]);
        for (i = 0; i < e; ++i) "^" === b[i] && "^" !== b[i + 1] && (b[i] = "");
        if (a.ignoreCase && g)
          for (i = 0; i < e; ++i)
            (k = b[i]), (a = k.charAt(0)), 2 <= k.length && "[" === a
              ? (b[i] = d(k))
              : "\\" !== a &&
                (b[i] = k.replace(/[a-zA-Z]/g, function(a) {
                  a = a.charCodeAt(0);
      ...
      for (var f = 0, g = !1, h = !1, i = 0, j = a.length; i < j; ++i) {
        ...
        if (k.ignoreCase) h = !0;
          ...
          /[a-z]/i.test(
            k.source.replace(/\\u[0-9a-f]{4}|\\x[0-9a-f]{2}|\\[^ux]/gi, "")
          )
        ) {
          g = !0;
          h = !1;
      ...
      for (
        var l = { b: 8, t: 9, n: 10, v: 11, f: 12, r: 13 },
          m = [],
          i = 0,
          j = a.length;
        i < j;
        ...
        k = a[i];
        if (k.global || k.multiline) throw Error("" + k);
        m.push("(?:" + e(k) + ")");
      }
    ...
    function c(a, b, c, d, e) {
      c &&
        (
          (a = { h: a, l: 1, j: null, m: null, a: c, c: null, i: b, g: null }),
          d(a),
          e.push.apply(e, a.g)
        );
    }
    function d(a) {
      for (var b = void 0, c = a.firstChild; c; c = c.nextSibling)
        var d = c.nodeType,
          b =
            1 === d ? (b ? a : c) : 3 === d ? (t.test(c.nodeValue) ? a : b) : b;
      return b === a ? void 0 : b;
    }
    function e(b, d) {
      function e(a) {
        for (
          ...
          var q = m[o],
            ...
            s = void 0,
            t;
          if ("string" === typeof r) t = !1;
          else {
            var u = f[q.charAt(0)];
            if (u) (s = q.match(u[1])), (r = u[0]);
            else {
              for (t = 0; t < h; ++t)
                if (((u = d[t]), (s = q.match(u[1])))) {
                  r = u[0];
                  break;
                }
              s || (r = "pln");
            }
            !(t = 5 <= r.length && "lang-" === r.substring(0, 5)) ||
              (s && "string" === typeof s[1]) ||
              ((t = !1), (r = "src"));
            t || (n[q] = r);
          }
          ...
          if (t) {
            ...
            var v = q.indexOf(t),
              w = v + t.length;
            s[2] && ((w = q.length - s[2].length), (v = w - t.length));
            r = r.substring(5);
            c(j, b + u, q.substring(0, v), e, k);
            c(j, b + u + v, t, i(r, t), k);
            c(j, b + u + w, q.substring(w), e, k);
          } else k.push(b + u, r);
        }
        a.g = k;
      }
      ...
      (function() {
        for (
          var c = b.concat(d), e = [], h = {}, i = 0, j = c.length;
          i < j;
          ++i
        ) {
          var k = c[i],
            l = k[3];
          if (l) for (var m = l.length; 0 <= --m; ) f[l.charAt(m)] = k;
          k = k[1];
          l = "" + k;
          h.hasOwnProperty(l) || (e.push(k), (h[l] = null));
        }
        e.push(/[\0-\uffff]/);
        g = a(e);
      })();
    ...
    function g(a, b, c) {
      function d(a) {
        ...
        if (1 == b && !f.test(a.className))
          ...
          j &&
            (
              (b = i.substring(0, j.index)),
              (a.nodeValue = b),
              (i = i.substring(j.index + j[0].length)) &&
                a.parentNode.insertBefore(h.createTextNode(i), a.nextSibling),
              e(a),
      ...
      function e(a) {
        ...
        a = b(a.nextSibling, 0);
        for (var c; (c = a.parentNode) && 1 === c.nodeType; ) a = c;
        j.push(a);
      }
      for (
        var f = /(?:^|\s)nocode(?:\s|$)/,
      ...
      b === (b | 0) && j[0].setAttribute("value", b);
      var l = h.createElement("ol");
      l.className = "linenums";
      b = Math.max(0, (b - 1) | 0) || 0;
      for (var k = 0, m = j.length; k < m; ++k)
        (i = j[k]), (i.className = "L" + (k + b) % 10), i.firstChild ||
          i.appendChild(h.createTextNode(" ")), l.appendChild(i);
      a.appendChild(l);
    }
    function h(a, b) {
      for (var c = b.length; 0 <= --c; ) {
        var d = b[c];
        v.hasOwnProperty(d)
          ? k.console && console.warn("cannot override language handler %s", d)
          : (v[d] = a);
      }
    }
    function i(a, b) {
    ...
    function j(a) {
      ...
      try {
        ...
        var p, q;
        for (q = p = 0; q < n; )
          m[q] !== m[q + 2] ? ((m[p++] = m[q++]), (m[p++] = m[q++])) : (q += 2);
        n = p;
        for (q = p = 0; q < n; ) {
          for (
            var r = m[q], s = m[q + 1], t = q + 2;
            t + 2 <= n && m[t + 1] === s;
        ...
        var u = a.h;
        a = "";
        u && ((a = u.style.display), (u.style.display = "none"));
        try {
          for (; e < l; ) {
            var v = j[e + 2] || h,
              w = m[o + 2] || h,
              ...
              x = j[e + 1],
              y;
            if (1 !== x.nodeType && (y = g.substring(d, t))) {
              f && (y = y.replace(c, "\r"));
              x.nodeValue = y;
              ...
              d < v &&
                (
                  (j[e + 1] = x = z.createTextNode(g.substring(t, v))),
                  B.insertBefore(x, A.nextSibling)
                );
            }
            d = t;
            d >= v && (e += 2);
        ...
        k.console && console.log((a && a.stack) || a);
      }
    }
    var k = window,
    ...
    h(e([], [["atv", /^[\s\S]+/]]), ["uq.val"]);
    h(
      f({ keywords: n, hashComments: !0, cStyleComments: !0, types: s }),
      "c cc cpp cxx cyc m".split(" ")
    );
    h(f({ keywords: "null,true,false" }), ["json"]);
    h(
      f({
        keywords: p,
        hashComments: !0,
    ...
    h(f({ keywords: o, cStyleComments: !0 }), ["java"]);
    h(f({ keywords: l, hashComments: !0, multiLineStrings: !0 }), [
      "bash",
      "bsh",
      "csh",
      "sh"
    ...
    h(f({ keywords: m, cStyleComments: !0, regexLiterals: !0 }), [
      "javascript",
      "js"
    ]);
    h(
    ...
    var w = (k.PR = {
        ...
        PR_TAG: "tag",
        PR_TYPE: "typ",
        prettyPrintOne: (k.prettyPrintOne = function(a, b, c) {
          c = c || !1;
          b = b || null;
          ...
          d = d.firstChild;
          c && g(d, c, !0);
          j({ j: b, m: c, h: d, l: 1, a: null, i: null, c: null, g: null });
          return d.innerHTML;
        }),
        prettyPrint: (k.prettyPrint = function(a, b) {
          function c() {
            for (
              var b = k.PR_SHOULD_USE_CONTINUATION ? n.now() + 250 : Infinity;
              o < h.length && n.now() < b;
              o++
            ) {
              for (var e = h[o], i = v, l = e; (l = l.previousSibling); ) {
                var m = l.nodeType,
                  w = (7 === m || 8 === m) && l.nodeValue;
                if (
                  w
                    ? !/^\??prettify\b/.test(w)
                    : 3 !== m || /\S/.test(l.nodeValue)
                )
                  break;
                if (w) {
                  i = {};
              ...
              l = e.className;
              if ((i !== v || q.test(l)) && !r.test(l)) {
                m = !1;
                for (w = e.parentNode; w; w = w.parentNode)
                  if (u.test(w.tagName) && w.className && q.test(w.className)) {
                    m = !0;
                    break;
                  }
                if (!m) {
                  ...
                  if (!m) {
                    ...
                    !m &&
                      (x = d(e)) &&
                      t.test(x.tagName) &&
                      (m = x.className.match(p));
                    m && (m = m[1]);
                  }
                  if (s.test(e.tagName)) w = 1;
                  else
                    var w = e.currentStyle,
                      y = f.defaultView,
                      w =
                        (w = w
                          ? w.whiteSpace
                          : y && y.getComputedStyle
                            ...
                            : 0) && "pre" === w.substring(0, 3);
                  y = i.linenums;
                  (y = "true" === y || +y) ||
                    (y = (y = l.match(/\blinenums\b(?::(\d+))?/))
          ...
          for (
            var e = b || document.body,
              f = e.ownerDocument || document,
              e = [
                e.getElementsByTagName("pre"),
                e.getElementsByTagName("code"),
                e.getElementsByTagName("xmp")
              ],
              h = [],
              i = 0;
            i < e.length;
            ...
            for (var l = 0, m = e[i].length; l < m; ++l) h.push(e[i][l]);
          var e = null,
            n = Date;
          n.now ||
            (n = {
    ...
    "function" === typeof n &&
      n.amd &&
      n("google-code-prettify", [], function() {
        return w;
      });
  })();
})();
...
(mr_transforms = [
  ...
  "mozTransform",
  "oTransform"
]), (mr_transformproperty = getSupportedPropertyName(
  mr_transforms
)), (mr_scrollElement = window), $(document).ready(function() {
  "use strict";
  $("a").click(function() {
    if ($(this).attr("href") === "#") {
      return false;
  ...
  $(".ytplayer").each(function() {
    ...
    $(this).attr(
      ...
      "{videoURL:'" +
        a +
        "',containment:'.video-holder',autoPlay:true, mute:true, startAt:28,opacity:1}"
    );
  });
  ...
  $(".add-to-cart .less").click(function() {
    if ($(this).closest("form").find('input[type="text"]').val() >= 1) {
      var a =
        parseInt($(this).closest("form").find('input[type="text"]').val()) - 1;
      $(this).closest("form").find('input[type="text"]').val(a);
    }
  });
    ...
    $(this).mousemove(function(a) {
      if (!mr_parallax.getScrollingState()) {
        $(this)
          ...
          .css(
            mr_transformproperty,
            "translate3d(" +
              -a.pageX / 18 +
              "px," +
              -(a.pageY - mr_getScrollPosition()) / 50 +
              "px, 0)"
          );
      }
      $(this)
        ...
        .css(
          mr_transformproperty,
          "translate3d(" + -a.pageX / 30 + "px," + -a.pageY / 30 + "px, 0px)"
        );
      $(this)
        .find(".layer-2")
        .css(
          mr_transformproperty,
          "translate3d(" + -a.pageX / 20 + "px," + -a.pageY / 20 + "px, 0px)"
        );
    });
  });
  $(".promo-1 .btn")
  ...
  $(".contained-projects").each(function() {
    ...
    $(this).find(".project").each(function() {
      ...
      b.forEach(function(b) {
        if (a.indexOf(b) == -1) {
          a +=
            '<li data-filter="' + b + '">' + capitaliseFirstLetter(b) + "</li>";
        }
      });
      $(this)
        .closest(".contained-projects")
        .find("ul.filters")
        .empty()
  ...
  $(".video-strip .pre-video i").click(function() {
    ...
    $(this)
      .closest(".video-strip")
      .find(".iframe-holder")
      .addClass("show-iframe");
    var a = $(this);
    setTimeout(function() {
      a.closest(".video-strip").find(".iframe-holder").addClass("fade-on");
    }, 500);
  });
  $(".video-strip .close-frame").click(function() {
    ...
    setTimeout(function() {
      a
        .closest(".video-strip")
        .find(".iframe-holder")
        .removeClass("show-iframe");
      a.closest(".video-strip").find(".pre-video").removeClass("fade-off");
    }, 500);
  });
  ...
  jQuery(".tweets-feed")
    ...
    .each(function(a) {
      var b = {
        ...
        domId: "",
        maxTweets: jQuery("#tweets-" + a).attr("data-amount"),
        enableLinks: true,
        showUser: true,
        showTime: true,
        dateFunction: "",
      ...
      function c(b) {
        var c = b.length;
        var d = 0;
        var e = document.getElementById("tweets-" + a);
  ...
  if ($(".instafeed").length) {
    ...
    $(".instafeed").each(function() {
      var a = $(this).attr("data-user-name") + "_";
      $(this).children("ul").spectragram("getUserFeed", { query: a, max: 12 });
    });
  }
  ...
  $(
    "form.form-email, form.form-newsletter, form.early-access, form.form-bigquery"
  ).submit(function(b) {
    ...
    var c = $(this).closest(
      ...
      k,
      l;
    g = $(c).find("iframe.mail-list-form");
    ...
    if (
      g.length &&
      typeof g.attr("srcdoc") !== "undefined" &&
      g.attr("srcdoc") !== ""
    ) {
      h = $(c).find(".signup-email-field").val();
      i = $(c).find(".signup-name-field").val();
      if ($(c).find("input.signup-first-name-field").length) {
        j = $(c).find("input.signup-first-name-field").val();
      } else {
        j = $(c).find(".signup-name-field").val();
      }
      k = $(c).find(".signup-last-name-field").val();
      if (a(c) !== 1) {
        ...
        console.log(j);
        console.log(i);
        g.contents().find("#mce-EMAIL, #fieldEmail").val(h);
        g.contents().find("#mce-LNAME, #fieldLastName").val(k);
        g.contents().find("#mce-FNAME, #fieldFirstName").val(j);
        g.contents().find("#mce-NAME, #fieldName").val(i);
        g.contents().find("form").attr("target", "_blank").submit();
        l = c.attr("success-redirect");
        if (typeof l !== typeof undefined && l !== false && l !== "") {
          window.location = l;
        }
      } else {
        c.find(".form-error").fadeIn(1e3);
        setTimeout(function() {
          c.find(".form-error").fadeOut(500);
        }, 5e3);
      }
    } else {
      if (typeof e !== typeof undefined && e !== false) {
        c.find(".form-error").text(e);
      }
      d = a(c);
      if (d === 1) {
        ...
        f = jQuery("<div />")
          ...
          .insertAfter($(c).find('input[type="submit"]'));
        $(c).find('input[type="submit"]').attr("disabled", "disabled");
        jQuery.ajax({
          type: "POST",
          url: "/email",
          data: c.serialize() + "&url=" + window.location.href,
          success: function(a) {
            $(c).find(".form-loading").remove();
            $(c).find('input[type="submit"]').removeAttr("disabled");
            if (a === "ok") {
              $(c).find(".wrapper").fadeOut(100);
              l = c.attr("success-redirect");
              if (typeof l !== typeof undefined && l !== false && l !== "") {
                setTimeout(function() {
                  window.location = l;
              ...
              c.find("textarea").val("");
              c.find(".form-success").fadeIn(1e3).css("margin-top", "0px");
              c.find(".form-error").fadeOut(1e3);
            } else {
              c
                .find(".form-error")
                .attr("original-error", c.find(".form-error").text());
              c.find(".form-error").text(a).fadeIn(1e3);
              c.find(".form-success").fadeOut(1e3);
            }
          },
          error: function(a, b, d) {
            c
              .find(".form-error")
              .attr("original-error", c.find(".form-error").text());
            c.find(".form-error").text(d).fadeIn(1e3);
            c.find(".form-success").fadeOut(1e3);
            $(c).find(".form-loading").remove();
            $(c).find('input[type="submit"]').removeAttr("disabled");
          }
  ...
  function a(a) {
    ...
    $(a).find('.validate-required[type="checkbox"]').each(function() {
      if (!$('[name="' + $(this).attr("name") + '"]:checked').length) {
        c = 1;
        b = $(this).attr("name").replace("[]", "");
        a.find(".form-error").text("Please check at least one " + b + " box.");
      }
    });
    ...
    if (!a.find(".field-error").length) {
      a.find(".form-error").fadeOut(1e3);
    }
    return c;
  }
  ...
  if (
    ...
    if ($("[data-maps-api-key]").length) {
      ...
      var c = $("[data-maps-api-key]:first").attr("data-maps-api-key");
      b.type = "text/javascript";
      b.src =
        "https://maps.googleapis.com/maps/api/js?key=" +
        c +
        "&callback=initializeMaps";
      b.className = "gMapsAPI";
  ...
  function g() {
    ...
    var b = 259292566;
    var c = b / 100 * a;
    var g = parseFloat(d.val());
    var h = parseFloat($("input[name=timeFrame]:checked").val()) || 0;
  ...
  d.slider({
    ticks: [100, 200, 300, 400, 500, 1e3, 2e3, 3e3, 4e3, 5e3, 1e4],
    ticks_positions: [0, 5, 10, 15, 20, 30, 40, 50, 60, 70, 100],
...
$(window).load(function() {
  ...
  if ($("nav").hasClass("nav-2")) {
    $(".inner-link").smoothScroll({ offset: -55, speed: 800 });
  } else {
    var a = $("nav").outerHeight();
    $(".inner-link").smoothScroll({ offset: -a, speed: 800 });
  }
...
function mr_getScrollPosition() {
  return mr_scrollElement != window
    ? mr_scrollElement.scrollTop
