...
{
    public class RandomServantOfCostFilter<Q> : IServantCardFilter where Q : IQuantity
    {
        public Func<Card, bool> Filter()
        {
            ...
            List<Card> servants = lstCardLib.Where(c => c.Cost == qat.Quantity && c.CardType == CardType.随从 && c.Profession == Profession.Neutral && c.IsDerivative == false).ToList();
