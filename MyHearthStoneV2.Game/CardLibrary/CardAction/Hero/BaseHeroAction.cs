...
{
    internal static class BaseHeroAction
    {
        /// <summary>
        ...
        //internal static void DeductionBiologyLife(this BaseHero sourceCard, GameContext context, Card triggerCard,
        //    int damege)
        //{
        ...
        /// <param name="context"></param>
        //internal static void BiologyDead(this BaseHero sourceCard, Card targetCard, GameContext context)
        //{
        //    //英雄死亡
        ...
        /// 英雄受到伤害（被火球砸、火冲点）
        /// </summary>
        //internal static void BiologyByDamege(this BaseHero sourceCard, Card targetCard, GameContext context, int damege)
        //{
        ...
        /// 被攻击
        /// </summary>
        //internal static void UnderAttack(this BaseHero baseHero, GameContext gameContext, BaseBiology attackCard)
        //{
        ...
        /// <param name="targetCard"></param>
        //internal static void Attack(this BaseHero baseHero, GameContext gameContext, BaseBiology targetCard)
        //{
        ...
        //internal static void LoadEquip(this BaseHero baseHero, GameContext gameContext, BaseEquip equip)
        //{
        //    if (baseHero.Equip != null)
        //    {
        ...
        //internal static void Cast(this BaseHero hero, GameContext gameContext, int location, int target)
        //{
        ...
        /// <param name="gameContext"></param>
        //internal static void ResetRemainAttackTimes(this BaseHero hero, GameContext gameContext)
        //{
