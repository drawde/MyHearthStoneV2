...
{
    internal static class BaseServantAction
    {
        /// <summary>
        ...
        //internal static void DeductionBiologyLife(this BaseServant sourceCard, GameContext context, Card triggerCard, int damege)
        //{
        ...
        /// 随从受到伤害（被火球砸、火冲点）
        /// </summary>
        //internal static void BiologyByDamege(this BaseServant sourceCard, Card targetCard, GameContext context, int damege)
        //{
        ...
        /// <param name="context"></param>
        //internal static void BiologyDead(this BaseServant sourceCard, Card targetCard, GameContext context)
        //{
        //    //随从死亡
        ...
        /// 被攻击
        /// </summary>
        //internal static void UnderAttack(this BaseServant servant, GameContext gameContext, BaseBiology attackCard)
        //{
        ...
        //        CardActionParameter para = new CardActionParameter()
        //        {
        //            GameContext = gameContext,
        //            MainCard = servant,
        //            SecondaryCard = attackCard,
        //        };
        //        abiliti.CastAbility(para);
        //    }
        //    else
        //    {
        ...
        /// <param name="targetCard"></param>
        //internal static void Attack(this BaseServant servant, GameContext gameContext, BaseBiology targetCard)
        //{
        //    //攻击对方
        ...
        //internal static void Cast(this BaseServant servant, GameContext gameContext, int location, int target)
        //{
        ...
        //    {
        //        servant.Abilities.First(c => c.AbilityType == AbilityType.冲锋).CastAbility(new CardActionParameter() { GameContext = gameContext, MainCard = servant, MainCardLocation = location });
        //    }
        //}
        ...
        /// <param name="gameContext"></param>
        //internal static void ResetRemainAttackTimes(this BaseServant servant, GameContext gameContext)
        //{
