...
{
    internal static class BaseBiologyAction
    {
        /// <summary>
        ...
        //internal static void DeductionBiologyLife(this BaseBiology sourceCard, GameContext context, Card triggerCard, int damege)
        //{
        ...
        /// <param name="context"></param>
        /// <param name="triggerCard"></param>
        //internal static void BiologyDead(this BaseBiology sourceCard, GameContext context, Card triggerCard)
        //{
        //    if (sourceCard.CardType == CardType.英雄)
        //    {
        ...
        /// 随从、英雄受到伤害（被火球砸、火冲点）
        /// </summary>
        //internal static void BiologyByDamege(this BaseBiology sourceCard, Card targetCard, GameContext context, int damege)
        //{
        //    if (sourceCard.CardType == CardType.英雄)
        //    {
        ...
        /// 被攻击
        /// </summary>
        //internal static void UnderAttack(this BaseBiology sourceCard, GameContext gameContext, BaseBiology attackCard)
        //{
        //    if (sourceCard.CardType == CardType.英雄)
        //    {
        ...
        //internal static void Attack(this BaseBiology sourceCard, GameContext gameContext, BaseBiology targetCard)
        //{
        //    if (sourceCard.CardType == CardType.英雄)
        //    {
        ...
        //internal static void Cast(this BaseBiology biology, GameContext gameContext, int location, int target)
        //{
        ...
        /// <param name="biology"></param>
        /// <param name="gameContext"></param>
        //internal static void ResetRemainAttackTimes(this BaseBiology biology, GameContext gameContext)
        //{
        //    if (biology.CardType == CardType.英雄)
        //    {
